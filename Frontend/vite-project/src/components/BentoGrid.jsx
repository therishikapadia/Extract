  ...
  return (
    ...
    >
      <motion.div className="h-full w-full rounded-lg flex items-center justify-center">
        <Camera className="w-8 h-8 text-white/80 dark:text-black/80" />
      </motion.div>
    </motion.div>
  );
};
    ...
    <motion.div
      ...
      <motion.div
        ...
        <p className="text-xs text-neutral-500">
          There are a lot of snacks labeled ‘healthy’ out there like granola bars, fruit juices, low-fat chips... but are they really?
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
        className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center justify-end space-x-2 w-3/4 ml-auto bg-white dark:bg-black">
        <p className="text-xs text-neutral-500">Eat it anyway</p>
        <div
          className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>
    </motion.div>
...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Allergens? Additives? We flag what matters, fast.
      </span>
    ),
    header: <SkeletonOne />,
...
},
{
    ...
    description: (
        <span className="text-sm">
        Uncover the hidden ingredients and nutrition secrets at a glance.
      </span>
    ),
    header: <SkeletonTwo />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Just click a photo of the label. We’ll handle the science.
      </span>
    ),
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Say no to shady sugars, sneaky sodium, and chemical chaos.
      </span>
    ),
    header: <SkeletonFour />,
...

  {
    ...
    description: (
      <span className="text-sm">
        Go beyond the label — understand what you're really consuming.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
